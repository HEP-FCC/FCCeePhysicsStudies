...
## All studies in CCP group
### Experimental studies

| Topic                        | Study                               | Status                                    | Contact                                                                                         |
| ---------------------------- | ----------------------------------- | ----------------------------------------- | ----------------------------------------------------------------------------------------------- |
| Direct CKM measurements      | Vcb, Vcs from WW decays             | Past work + To be continued with EW group | Michele Tammaro (mike.tamma@gmail.com), FCC EW group (FCC-PED-PhysicsGroup-EWPrecision@cern.ch) |
|                              | Vtb, Vts from top decays            | Past work + dormant                       | Xunwu Zuo (xunwu.zuo@cern.ch)                                                                   |
|                              | Vcb, Vub from Bc/Bu leptonic decays | Past work + ongoing                       | Vasilisa Guliaeva(vasilisa.guliaeva@cern.ch), Xunwu Zuo (xunwu.zuo@cern.ch)                     |
|                              |                                     |                                           |                                                                                                 |
| Traditional CKM measurements | Inclusive                           | To be covered                             | Markus Prim (markus.prim@uni-bonn.de), Dean Robinson (drobinson@lbl.gov), Matthew Rudolph (msrudolp@syr.edu)                                                                                                |
|                              | Exclusive                           | To be covered                             | Markus Prim (markus.prim@uni-bonn.de), Dean Robinson (drobinson@lbl.gov), Matthew Rudolph (msrudolp@syr.edu)                                                                                                |
|                              | Double inclusive                    | Proposed, to crystallise                  |                                                                                                 |
|                              |                                     |                                           |                                                                                                 |
| LFU                          | R(Hc) ratios                        | To be covered                             |                                                                                                 |
|                              |                                     |                                           |                                                                                                 |
...
| Topic                  | Study                    | Status               | Contact                                  |
| ---------------------- | ------------------------ | -------------------- | ---------------------------------------- |
| LQCD                   | LQCD projections         | Ongoing              | Andrea Jüttner (Andreas.Juttner@cern.ch) |
| LFU                    | Sum rule $b\to c\ell\nu$ | Ongoing              | Syuhei Iguro (igurosyuhei@gmail.com)     |
| Hadronization fraction | Bc fraction              | To crystallise ideas |                                          |

### Other contributions
- Matthew Rudolph (msrudolp@syr.edu) expressed general interest in semileptonic decays
